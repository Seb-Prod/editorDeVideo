...
metaData = app.get_metadata(
    "/Volumes/Macintosh HD/Users/seb/Downloads/Interior.Chinatown.S01E02.FRENCH.WEBRip.x264-Wawacity.run.mp4")
...
def main(page: ft.Page):
    ...
    def handle_change(e):
        button_open_date_picker.text = f"{e.control.value.strftime('%d-%m-%Y')}"
        page.add()
    ...
    def set_input_value():
        ...
        imgage.src_base64 = metaData.image
        page.update()
    ...
    page.add(
        ft.Column([
            ...
            ft.Row([
            ft.Column(
                [input_episode_name, input_show_name, ft.Row([input_season, input_episode, button_open_date_picker]), input_genre, input_episode_description, input_episode_long_description, input_show_description], width=340),
            ft.Column([imgage])
        ])
        ])
